...
/// iOS 是否使用 ijk 播放器
- (void)gsx_rtc_engine_ios_ijk_used:(int)ijk_userd;
...
// 获取播放设置的缓冲时长
- (int)gsx_rtc_engine_play_get_buffering_time:(void *)in_pVoid :(int)isIjk;
...
- (void) gsx_rtc_engine_set_volume_level:(void *)in_pVoid :(float) percent;
...
// 采集视频
- (int) gsx_rtc_engine_capture_video_set_captureMode:(void *)in_pVoid :(GsxCaptureModeType) captureMode;
...
// 通过stream_id设置流类型
- (void) gsx_rtc_engine_set_stream_type:(void *)in_pVoid :(int)stream_id :(int)stream_type;

// 重设卡顿指标参数
- (void) gsx_rtc_engine_set_threshold_params:(BlockThresholdParams)thresholdParams;
