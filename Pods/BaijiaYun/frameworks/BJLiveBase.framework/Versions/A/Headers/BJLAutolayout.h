...
*bjl_left, *bjl_right, *bjl_top, *bjl_bottom, *bjl_leading, *bjl_trailing,
*bjl_width, *bjl_height, *bjl_centerX, *bjl_centerY;
@end

@protocol BJLLayoutAttribute <BJLLayoutGuide>
@property (nonatomic, readonly) BJLConstraintTarget
*bjl_firstBaseline, *bjl_lastBaseline,
...
@property (nonatomic, readonly) BJLConstraintTarget
*bjl_topLayoutGuide, *bjl_topLayoutGuideTop, *bjl_topLayoutGuideBottom,
