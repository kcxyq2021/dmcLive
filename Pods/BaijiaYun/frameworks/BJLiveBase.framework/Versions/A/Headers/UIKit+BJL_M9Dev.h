 ...
 */
static inline NSString *BJLAliIMGURLParams_aspectScale(NSInteger width, NSInteger height, NSInteger scale, BOOL fill,
...
static inline NSString *BJLAliIMGURLString_aspectScale(NSInteger width, NSInteger height, NSInteger scale, BOOL fill,
                                                       NSString *urlString, NSString * _Nullable ext) {
...
static inline NSString *BJLAliIMG_aspectFill(CGSize size, CGFloat scale,
                                             NSString *urlString, NSString * _Nullable ext) {
    return BJLAliIMGURLString_aspectScale(round(size.width), round(size.height), scale, YES, urlString, ext);
}

static inline NSString *BJLAliIMG_aspectFit(CGSize size, CGFloat scale,
                                            NSString *urlString, NSString * _Nullable ext) {
