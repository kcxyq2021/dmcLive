...
/** 分页加载更多作业 */
- (nullable BJLError *)loadMoreHomeworksWithCount:(NSInteger)count;

/**
 当前教室是否所有学生都支持作业功能
 #discussion NO 表示当前教室存在不支持作业功能的用户
 */
...
/**
 ...
 - document         非 nil 即为成功，可按需调用`BJLDocumentVM`的`addDocument:`同步到教室内文件打开
 - error            错误
 #return task
 */
- (NSURLSessionUploadTask *)uploadHomeworkFile:(NSURL *)fileURL
